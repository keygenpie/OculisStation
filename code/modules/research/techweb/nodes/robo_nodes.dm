/datum/techweb_node/robotics
	...
	unlocked_designs = list(
		...
		/datum/design/spraycan/roboticist // OCULIS EDIT ADDITION
	)
...
/datum/techweb_node/ai
	...
	unlocked_designs = list(
		...
		/datum/design/board/crewsimov_module, // OCULIS EDIT ADDITION START
		/datum/design/board/sophontsimov_module,
		/datum/design/board/noidimov_module,
		/datum/design/board/godcomplex_module, // OCULIS EDIT ADDITION END
	)
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = TECHWEB_TIER_1_POINTS)
