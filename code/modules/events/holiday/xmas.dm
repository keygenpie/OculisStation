...
/obj/effect/spawner/xmastree
	...
	var/christmas_tree = /obj/structure/flora/tree/pine/xmas/presents/safe //IRIS EDIT - adds the safe version - original: /obj/structure/flora/tree/pine/xmas/presents
