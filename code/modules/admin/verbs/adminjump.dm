ADMIN_VERB(jump_to_area, R_ADMIN|R_DEBUG, "Jump To Area", "Jumps to the specified area.", ADMIN_CATEGORY_GAME) // OCULIS EDIT, ORIGINAL: ADMIN_VERB(jump_to_area, R_ADMIN, "Jump To Area", "Jumps to the specified area.", ADMIN_CATEGORY_GAME)
...
ADMIN_VERB(jump_to_coord, R_ADMIN|R_DEBUG, "Jump To Coordinate", "Jump to a specific coordinate in the game world.", ADMIN_CATEGORY_GAME) // OCULIS EDIT, ORIGINAL: ADMIN_VERB(jump_to_coord, R_ADMIN, "Jump To Coordinate", "Jump to a specific coordinate in the game world.", ADMIN_CATEGORY_GAME)
...
ADMIN_VERB_AND_CONTEXT_MENU(send_mob, R_ADMIN|R_DEBUG, "Send Mob", "Teleport the specified mob to an area of your choosing.", ADMIN_CATEGORY_GAME, /mob) // OCULIS EDIT, ORIGINAL: ADMIN_VERB_AND_CONTEXT_MENU(send_mob, R_ADMIN, "Send Mob", "Teleport the specified mob to an area of your choosing.", ADMIN_CATEGORY_GAME, /mob)
